...
if(isset($_POST['nurse_reg'])){
  ...
  $result = $nurse_obj->singUpNurse($nm, $em, $gndr, $cnic, $pwd, $loc, $img, $cont, $exp, $sal);
}
...
<body style="background-color:black;">
  <div class="main_container login_signup_container">
    <h1 style="margin-bottom: 30px;">Nurse Sign Up</h1>
    <form action="" method="POST" novalidate enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="form-group col-sm-4">
          ...
          <input required type="number" max="90" name="exp" class="form-control" placeholder="Years">
        </div>
        <div class="form-group col-sm-4">
          <label>Salary</label>
          <input required type="number" name="salary" class="form-control" placeholder="PKR">
        </div>
      </div>
      <div class="form-group">
        <label>CNIC</label>
      ...
      <input type="submit" value="Sign Up" name="nurse_reg">
