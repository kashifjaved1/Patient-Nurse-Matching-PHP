...
class Friend{
    ...
    public function cancel_or_ignore_n_friend_request($my_id, $user_id){
    ...
    public function p2n_request_notification($my_id, $send_data){
        try{
    ...
    // Nurse -> Patient REQUEST NOTIFICATIONS
    public function n2p_request_notification($my_id, $send_data){
        try{
            $sql = "SELECT sender, name, img FROM `friend_request` JOIN nurse ON friend_request.sender = nurse.id WHERE receiver = ?";
