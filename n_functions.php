...
if(isset($_POST['accept']) or isset($_POST['reject'])){
    echo "here";
    ...
    $ed = $_POST['ed'];
    $py = $_POST['py'];
    $frnd_obj->acceptORreject($pid, $nid, $sd, $ed, $py, $req);
}
else if(isset($_GET['agmt_id']) && isset($_GET['rid'])){
    $ret_id = $_GET['rid'];
    $agmt_id = $_GET['agmt_id'];
    $frnd_obj->cancel_agmt($agmt_id, $ret_id);
}
